      ...
      <div className="flex-1 min-h-0 flex flex-col overflow-hidden bg-white sm:border sm:rounded-xl sm:mx-4 sm:mb-4">
        <div className="shrink-0 p-2 sm:p-2.5 border-b flex items-center gap-1 overflow-x-auto whitespace-nowrap hide-scrollbar">
          <button
            ...
            className="shrink-0 w-8 h-8 rounded-full overflow-hidden bg-slate-100 flex items-center justify-center cursor-pointer border"
          ...
          <div className="min-w-0 flex-1 max-w-[96px]">
          ...
          {canModerate && (!pkSession || pkSession.status !== 'live') ? (
            <Button
              className="shrink-0 h-8 px-2.5 rounded-lg bg-purple-500 hover:bg-purple-600 text-white text-xs font-bold"
      ...
      {showPeople ? (
        <div className="fixed inset-0 z-50">
          ...
          <div
            ...
            onClick={(e) => e.stopPropagation()} // 👈 يمنع الغلق جوه
          >
      ...
      {pkResultOpen && pkResultData ? (
        <div className="fixed inset-0 z-[90]">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-4">
            <div className="w-full max-w-xl overflow-hidden rounded-[30px] border border-white/70 bg-gradient-to-br from-white via-slate-50 to-slate-100 shadow-[0_25px_80px_rgba(15,23,42,0.28)]">
              <div className="border-b border-slate-200/80 bg-white/70 px-4 py-4 sm:px-6 sm:py-5">
                <div className="text-center text-xl sm:text-2xl font-black tracking-tight text-slate-900">
                  PK Result
                </div>
              </div>
              ...
              <div className="p-4 sm:p-6 space-y-5">
                <div className="text-center">
                  {pkResultData.winnerSide === "draw" ? (
                    <div className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-gradient-to-b from-white to-slate-100 px-4 py-2 text-sm sm:text-base font-black tracking-wide text-slate-600 shadow-[0_6px_18px_rgba(148,163,184,0.15)]">
                      <span className="relative inline-flex h-4 w-4 items-center justify-center">
                        <span className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(255,255,255,1),rgba(226,232,240,0.9)_60%,rgba(148,163,184,0.6)_100%)]" />
                        <span className="relative h-[2px] w-2 rounded-full bg-slate-500" />
                      </span>
                      <span>DRAW</span>
                    </div>
                  ) : (
                    <div
                      className={`inline-flex items-center rounded-full px-4 py-2 text-base sm:text-lg font-black shadow-sm border ${pkResultData.winnerSide === "A"
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <div
                    className={`rounded-3xl px-4 py-4 text-center border ${pkResultData.winnerSide === "A"
                      ? "border-fuchsia-300 bg-gradient-to-br from-fuchsia-50 via-white to-fuchsia-100/80 shadow-[0_12px_35px_rgba(245,158,11,0.18)]"
                      : pkResultData.winnerSide === "draw"
                        ? "border-fuchsia-200/70 bg-gradient-to-br from-fuchsia-50 via-white to-fuchsia-100/60 shadow-sm"
                        : "border-slate-200 bg-gradient-to-br from-slate-50 via-white to-slate-100 shadow-[0_6px_18px_rgba(148,163,184,0.12)]"
                      }`}
                  >
                    <div className="mb-2 flex items-center justify-center">
                      {pkResultData.winnerSide === "A" ? (
                        <span className="inline-flex items-center gap-2 rounded-full border border-fuchsia-200/80 bg-white/90 px-3 py-1.5 shadow-sm">
                          <span className="relative inline-flex h-6 w-6 items-center justify-center">
                            <span className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(255,248,220,0.98),rgba(253,224,71,0.9)_35%,rgba(245,158,11,0.85)_72%,rgba(180,83,9,0.7)_100%)] shadow-[0_3px_10px_rgba(245,158,11,0.28)]" />
                            <span className="absolute inset-[2px] rounded-full bg-[linear-gradient(180deg,rgba(255,255,255,0.75),rgba(255,255,255,0.08))]" />
                            <span className="relative flex translate-y-[1px] items-end justify-center gap-[2px]">
                              <span className="h-[8px] w-[4px] rounded-b-[1px] rounded-t-[3px] bg-[linear-gradient(180deg,#fff7cc,#facc15_58%,#d97706)] shadow-[0_1px_2px_rgba(0,0,0,0.18)]" />
                              <span className="h-[11px] w-[5px] rounded-b-[1px] rounded-t-[4px] bg-[linear-gradient(180deg,#fff7cc,#fbbf24_58%,#d97706)] shadow-[0_1px_2px_rgba(0,0,0,0.18)]" />
                              <span className="h-[8px] w-[4px] rounded-b-[1px] rounded-t-[3px] bg-[linear-gradient(180deg,#fff7cc,#facc15_58%,#d97706)] shadow-[0_1px_2px_rgba(0,0,0,0.18)]" />
                            </span>
                            <span className="absolute left-[5px] top-[5px] h-[2px] w-[2px] rounded-full bg-white/90 blur-[0.5px]" />
                          </span>

                          <span className="text-[10px] sm:text-xs font-black uppercase tracking-[0.18em] text-fuchsia-700">
                            Winner
                          </span>
                        </span>
                      ) : pkResultData.winnerSide === "draw" ? (
                        <span className="inline-flex items-center gap-1.5 rounded-full border border-fuchsia-200 bg-white px-3 py-1 text-[10px] sm:text-xs font-black uppercase tracking-[0.18em] text-fuchsia-700">
                          <span>🤝</span>
                          <span>Draw</span>
                        </span>
                      ) : (
                        <span className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 py-1 text-[10px] sm:text-xs font-black uppercase tracking-[0.18em] text-slate-400 shadow-none">
                          <span className="relative inline-flex h-6 w-6 items-center justify-center">
                            <span className="absolute top-[1px] left-1/2 h-[6px] w-[8px] -translate-x-1/2 rounded-b-[4px] bg-[linear-gradient(180deg,#a855f7,#7c3aed)]" />
                            <span className="absolute top-[4px] left-1/2 h-[3px] w-[3px] -translate-x-1/2 rounded-full bg-white/80" />
                            <span className="absolute bottom-[1px] left-1/2 h-[14px] w-[14px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(255,255,255,0.98),rgba(250,250,250,0.95)_12%,rgba(253,224,71,0.96)_34%,rgba(250,204,21,0.88)_62%,rgba(202,138,4,0.82)_100%)] shadow-[0_3px_8px_rgba(234,179,8,0.16)]" />
                            <span className="absolute bottom-[5px] left-1/2 h-[6px] w-[6px] -translate-x-1/2 rounded-full border border-white/50 bg-white/18" />
                            <span className="absolute bottom-[6px] left-1/2 h-[1.5px] w-[1.5px] -translate-x-1/2 rounded-full bg-white/90 blur-[0.4px]" />
                          </span>
                    ...
                    <div className="text-[11px] sm:text-xs font-extrabold uppercase tracking-[0.22em] text-fuchsia-700">
                      Side A
                    </div>

                    <div className="mt-2 text-3xl sm:text-4xl font-black tracking-tight text-fuchsia-600">
                      {pkResultData.scoreA}
                    </div>
                  </div>

                  <div
                    className={`rounded-3xl px-4 py-4 text-center border ${pkResultData.winnerSide === "B"
                      ? "border-cyan-300 bg-gradient-to-br from-cyan-50 via-white to-cyan-100/80 shadow-[0_12px_35px_rgba(245,158,11,0.18)]"
                      : pkResultData.winnerSide === "draw"
                        ? "border-cyan-200/70 bg-gradient-to-br from-cyan-50 via-white to-cyan-100/60 shadow-sm"
                        : "border-slate-200 bg-gradient-to-br from-slate-50 via-white to-slate-100 shadow-[0_6px_18px_rgba(148,163,184,0.12)]"
                      }`}
                  >
                    <div className="mb-2 flex items-center justify-center">
                      {pkResultData.winnerSide === "B" ? (
                        <span className="inline-flex items-center gap-2 rounded-full border border-cyan-200/80 bg-white/90 px-3 py-1.5 shadow-sm">
                          <span className="relative inline-flex h-6 w-6 items-center justify-center">
                            <span className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(255,248,220,0.98),rgba(253,224,71,0.9)_35%,rgba(245,158,11,0.85)_72%,rgba(180,83,9,0.7)_100%)] shadow-[0_3px_10px_rgba(245,158,11,0.28)]" />
                            <span className="absolute inset-[2px] rounded-full bg-[linear-gradient(180deg,rgba(255,255,255,0.75),rgba(255,255,255,0.08))]" />
                            <span className="relative flex translate-y-[1px] items-end justify-center gap-[2px]">
                          ...
                          <span className="text-[10px] sm:text-xs font-black uppercase tracking-[0.18em] text-cyan-700">
                            Winner
                          </span>
                        </span>
                      ) : pkResultData.winnerSide === "draw" ? (
                        <span className="inline-flex items-center gap-1.5 rounded-full border border-cyan-200 bg-white px-3 py-1 text-[10px] sm:text-xs font-black uppercase tracking-[0.18em] text-cyan-700">
                          <span>🤝</span>
                          <span>Draw</span>
                        </span>
                      ) : (
                    ...
                    <div className="text-[11px] sm:text-xs font-extrabold uppercase tracking-[0.22em] text-cyan-700">
                      Side B
                    </div>

                    <div className="mt-2 text-3xl sm:text-4xl font-black tracking-tight text-cyan-600">
                      {pkResultData.scoreB}
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 text-left">
                  <div className="rounded-3xl border border-fuchsia-100 bg-white/80 p-3 sm:p-4 shadow-sm">
                    <div className="mb-3 border-b border-fuchsia-100 pb-2 text-sm sm:text-base font-black text-fuchsia-700">
                      Side A Players
                    </div>
                      ...
                      {(pkResultData.sideAPlayers || []).length > 0 ? (
                        (pkResultData.sideAPlayers || []).map((p, idx) => (
                          <div
                            ...
                            className="flex items-center gap-2.5 rounded-2xl border border-slate-100 bg-white px-2.5 py-2 shadow-sm"
                          >
                            <div className="relative shrink-0">
                              ...
                              {pkResultData.winnerSide === "A" ? (
                                <span className="absolute -top-1 -right-1 inline-flex h-4 w-4 items-center justify-center rounded-full border border-amber-200/80 bg-[radial-gradient(circle_at_30%_30%,rgba(255,248,220,1),rgba(253,224,71,0.95)_40%,rgba(245,158,11,0.85)_80%)] shadow-[0_3px_6px_rgba(245,158,11,0.25)]">
                                  <span className="relative flex items-end justify-center gap-[1px] translate-y-[0.5px]">
                                    <span className="h-[4px] w-[2px] rounded-t-[2px] bg-[linear-gradient(180deg,#fff7cc,#facc15_60%,#d97706)]" />
                                    <span className="h-[6px] w-[2.5px] rounded-t-[3px] bg-[linear-gradient(180deg,#fff7cc,#fbbf24_60%,#d97706)]" />
                                    <span className="h-[4px] w-[2px] rounded-t-[2px] bg-[linear-gradient(180deg,#fff7cc,#facc15_60%,#d97706)]" />
                                  </span>
                                </span>
                              ) : pkResultData.winnerSide === "draw" ? null : (
                                <span className="absolute -top-1 -right-1 inline-flex h-4 w-4 items-center justify-center rounded-full border border-slate-200 bg-white shadow-[0_3px_6px_rgba(148,163,184,0.14)]">
                                  <span className="absolute top-[1px] left-1/2 h-[3px] w-[5px] -translate-x-1/2 rounded-b-[2px] bg-[linear-gradient(180deg,#a855f7,#7c3aed)]" />
                                  <span className="absolute bottom-[1px] left-1/2 h-[8px] w-[8px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_30%_30%,rgba(255,255,255,1),rgba(254,240,138,0.95)_32%,rgba(250,204,21,0.88)_64%,rgba(202,138,4,0.78)_100%)]" />
                                  <span className="absolute bottom-[4px] left-1/2 h-[2px] w-[2px] -translate-x-1/2 rounded-full border border-white/60 bg-white/15" />
                                </span>
                              )}
                            </div>

                            <div className="min-w-0">
                              <div className="truncate text-sm sm:text-[15px] font-bold text-slate-800">
                                {p.display_name || "User"}
                              </div>
                        ...
                        <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-3 py-4 text-center text-xs text-slate-400 italic">
                          No player
                        </div>
                      )}
                    </div>
                  ...
                  <div className="rounded-3xl border border-cyan-100 bg-white/80 p-3 sm:p-4 shadow-sm">
                    <div className="mb-3 border-b border-cyan-100 pb-2 text-sm sm:text-base font-black text-cyan-700">
                      Side B Players
                    </div>
                ...
                <div className="flex gap-3 pt-1">
                  <Button
                    variant="outline"
                    className="flex-1 rounded-2xl border-slate-300 bg-white py-2.5 text-slate-800 hover:bg-slate-50"
                    onClick={() => setPkResultOpen(false)}
                  >
                    Close
                  </Button>
                  ...
                  {canModerate ? (
                    <Button
                      className="flex-1 rounded-2xl bg-gradient-to-r from-violet-500 to-fuchsia-500 py-2.5 text-white shadow-sm hover:from-violet-600 hover:to-fuchsia-600"
                      onClick={() => {
                        setPkResultOpen(false);
                        setShowPkModal(true);
                      }}
