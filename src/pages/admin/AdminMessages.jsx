...
import { Send, X, Loader2, Upload, Clock, Zap, Bell, MessageSquare, Image as ImageIcon, Video, Lock } from 'lucide-react';
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-red-50 to-orange-50">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">⛔ لا توجد صلاحية</h1>
          <p className="text-gray-600 mb-6 text-lg">
            أنت غير مصرح بالدخول إلى هذه الصفحة
          </p>
          <p className="text-sm text-gray-500 bg-red-50 border border-red-200 rounded-lg p-4">
            تواصل مع مدير النظام لتفعيل صلاحية "إدارة الإشعارات" (Notifications) من لوحة موارد الموظفين
          </p>
          <a
            href="/admin"
            className="inline-block mt-6 px-6 py-2 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700 transition"
          >
            ← العودة للوحة المسؤول
          </a>
        </div>
      </div>
    );
