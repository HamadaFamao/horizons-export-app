...
import { Loader2, Search, Ban, Lock, Unlock, MessageSquare, MessageSquareOff, Mic, MicOff, Trash2, Shield, RefreshCw } from 'lucide-react';
              ...
              <TableRow key={room.id} className={!room.is_active ? 'opacity-50 bg-red-50' : ''}>
                ...
                <TableCell>
                  <div className="flex items-center gap-1 flex-wrap">
                    ...
                    >
                      {room.chat_disabled ? <MessageSquare className="h-4 w-4" /> : <MessageSquareOff className="h-4 w-4" />}
                    </Button>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <Button variant="outline" size="sm"
                    ...
                    {managingRoom.chat_disabled
                      ...
                      : <><MessageSquareOff className="h-4 w-4 mr-1" /> Disable Chat</>
                    }
                  </Button>
