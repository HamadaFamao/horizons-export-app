-- User Segment Queries for Admin Messages System (FIXED v2)
...
-- ============================================
SELECT u.id, p.name, u.email, p.is_vip, p.verified, p.last_seen_at
FROM auth.users u
...
ORDER BY p.is_vip DESC, p.last_seen_at DESC NULLS LAST;
...
-- ============================================
-- SIMPLE TEST: Count users in each segment
-- ============================================
SELECT
  'all' as segment,
